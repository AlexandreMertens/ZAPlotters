...
mllbb=761   # 500 575 761 662 286 216 248
numDirs=36
...
line = TLine(TGAS_2.GetX()[0],1,TGAS_2.GetX()[TGAS_2.GetN()-1],1)
line.SetLineWidth(2)
line.Draw()

leg = TLegend(0.3,0.68,0.49,0.88)
leg.SetLineColor(0)
leg.SetFillColor(0)
...
C.Print("plots_v1/BBP_"+str(mllbb)+"_Mu.pdf","pdf")
